...
# 仓库根目录 = 本脚本所在目录的上两级（analysis/ 的上级）
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
BASE_DIR = PROJECT_ROOT
MAPPED_DIR = os.path.join(BASE_DIR, 'analysis', 'V25_Full_Mapping')
EXPANDED_DIR = os.path.join(BASE_DIR, 'analysis', 'V27_Amap_Expansion')
OUT_DIR = os.path.join(BASE_DIR, 'analysis', 'V30_Multi_Source_Fusion_R2') # output V22_04R2 files
